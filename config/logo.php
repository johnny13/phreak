...
return [
    ...
    */
    ...
    'font' => resource_path('fonts/figlet/cholo.flf'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | An integer bitfield which defines how single characters are smushed together;
    | can be the sum of multiple values from Laminas\Text\Figlet\Figlet::SM_*
    |
    | Possible values: SM_EQUAL, SM_LOWLINE, SM_HIERARCHY, SM_PAIR, SM_BIGX, SM_HARDBLANK, SM_KERN, and SM_SMUSH
    |
    */
